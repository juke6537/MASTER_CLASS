...
hist(TPM_not_zero$WT_0_1, xlim = c(0,100), breaks = 1000)
...
hist(TPM_filtered$WT_0_1, xlim = c(0,150), breaks = 1000)
...
# First let's take the average across the row
...
# Yikes about a quarter of our data has an average TPM value of < 1
